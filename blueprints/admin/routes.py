...
@admin_bp.route('/config/general', methods=['GET', 'POST'])
@loc_required
def config_general():
    form = ConfigForm()
...
@admin_bp.route('/config/stats', methods=['GET', 'POST'])
@loc_required
def config_stats():
...
@admin_bp.route('/config/days/add', methods=['GET', 'POST'])
@loc_required
def config_day_add():
...
@admin_bp.route('/config/days/<int:day_number>/delete', methods=['POST'])
@loc_required
...
@admin_bp.route('/config/current-day', methods=['GET', 'POST'])
@loc_required
...
@admin_bp.route('/config/reset-cache', methods=['POST'])
@loc_required
